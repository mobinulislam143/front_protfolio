...
export function Lights() {
  return (
    <>
      <spotLight color="#61dafb" position={[-7, -7, -7]} intensity={0.2} />
      <spotLight color="#61dafb" position={[-7, 0, 12]} intensity={0.8} />
      <spotLight color="#61dafb" position={[-5, 20, 2]} intensity={0.5} />
      <spotLight color="#f2056f" position={[12, 8, -2]} intensity={2} />
      <spotLight color="#f2056f" position={[12, 8, 5]} intensity={1} />
      <spotLight color="#b107db" position={[5, -7, 5]} intensity={0.8} />
    </>
  );
}
