      ...
      <div className="card bg-white shadow-lg rounded-md h-full overflow-y-auto overflow-x-hidden">
        ...
        <div className="px-4 pb-5">
          ...
          {/* <textarea
            ...
            className="border-0 focus:outline-none outline-none text-black placeholder-gray-500 border-b w-full bg-white focus:border-b-2 focus:border-green-800 transition-all">
          </textarea> */}
