...
const About = () => {
  return (
      ...
      <div className="relative h-[600px] ">
        {/* <div className="card bg-white shadow-lg w-[500px] lg:w-[500px]  rounded-md h-full overflow-y-auto overflow-x-hidden "> */}
        {/* <div className="card bg-white shadow-lg rounded-md h-full overflow-y-auto overflow-x-hidden"> */}
  <div className="card bg-white shadow-lg w-full max-w-[370px] rounded-md h-full overflow-y-auto overflow-x-hidden">
